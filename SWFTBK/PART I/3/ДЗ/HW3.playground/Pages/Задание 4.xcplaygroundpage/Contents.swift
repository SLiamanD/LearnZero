...
enum ExtreemSituation {
    case A,B,C
}

var situtuation:ExtreemSituation = ExtreemSituation.C
situtuation = ExtreemSituation.B
situtuation = ExtreemSituation.A
switch situtuation {
case .A: print("Выключить все электрические приборы")
    fallthrough
case .B: print("Закрыть входные двери и окна")
    fallthrough
case .C: print("Соблюдать спокойствие")
default:break
}
